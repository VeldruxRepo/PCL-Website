...
export function Transformation() {
  return <section className="section">
    <Container><SectionHeading eyebrow="TRANSFORMATION" title="What weak post-click looks like — and what we build instead." /><div className="compare-grid"><article><h3>Before PCL</h3>  <span className="compare-grid__bridge" aria-hidden="true">
    →
